...
/**
    ...
    * instead it will only rerenders when the current todoStore is (de)selected.
    *
    * reactiveComponent((props) => {
    *     const todoStore = props.todoStore;
    *     const isSelected = mobx.expr(() => props.viewState.selection === todoStore);
    *     return <div className={isSelected ? "todoStore todoStore-selected" : "todoStore"}>{todoStore.title}</div>
    * });
    *
    */
